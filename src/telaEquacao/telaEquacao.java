...
public class telaEquacao extends javax.swing.JFrame {
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        lblDelta.setText(String.format("%.2f", d));// o %.2f significa numero rela com duas casa decimasis
        
        if ( d < 0){
            lblRaiz.setText("There is not Raizes Reais!");
        }else{
            lblRaiz.setText("There is raiz real!");
        }
